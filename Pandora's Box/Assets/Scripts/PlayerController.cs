...
public class PlayerController : MonoBehaviour
{
    ...
    private void Update()
    {
        if (Input.GetKeyDown(KeyCode.Escape) && _lossScreen.activeInHierarchy == false && _winScreen.activeInHierarchy == false)
        {
        ...
        {
            _hit.collider.GetComponent<EnemyController>().Aloccated(true);
            _raycastExit = true;
        ...
        {
            _raycastExit = false;
            _gameobjectHit.GetComponent<EnemyController>().Aloccated(false);
        }
    }
